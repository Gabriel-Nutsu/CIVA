window.onload = function() {
    document.getElementById("meus-prof-saude").onsubmit = tratarCamposAvancado;
}
...
tratarCamposAvancado = function() {
	var temErro = false;
	var camposErro = "";
	var campos = new Array("nome", "num-civa", "data-nascimento", "identidade", "pais-de-origem", "cargo", "email", "contato");
